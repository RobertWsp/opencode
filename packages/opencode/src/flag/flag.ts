...
export namespace Flag {
  ...
  /** Set truthy to force 5m cache TTL everywhere, disabling the adaptive 1h selection. */
  export const OPENCODE_CACHE_TTL_1H_DISABLED = truthy("OPENCODE_CACHE_TTL_1H_DISABLED")
  ...
  export const OPENCODE_EXPERIMENTAL_CAVEMAN =
    OPENCODE_EXPERIMENTAL || truthy("OPENCODE_EXPERIMENTAL_CAVEMAN")
  export const OPENCODE_EXPERIMENTAL_CAVEMAN_LEVEL = process.env["OPENCODE_EXPERIMENTAL_CAVEMAN_LEVEL"]
